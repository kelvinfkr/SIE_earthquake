...
\includegraphics[width=12cm]{Latex/table1_sise.pdf}\\
\end{figure}
...
\section*{Funding}
The research described in this paper was supported by the National Key Research and Development Program of China (2016YFC0701404), and the Career Development Fellowship from the University of Wollongong. %These supports are gratefully acknowledged.
